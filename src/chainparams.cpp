 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1624958004, nBits=1e0ffff0, nNonce=244960, vtx=1)
 *   CTransaction(hash=e0028e, ver=1, vin.size=1, vout.size=1, nLockTime=0)
 *     CTxIn(COutPoint(000000, -1), coinbase )
 *     CTxOut(nValue=50.00000000, scriptPubKey=0xA9037BAC7050C479B121CF)
 *   vMerkleTree: e0028e
 */
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    const char* pszTimestamp = "I could really use a peppermint tea right now it would help my stomach";
    const CScript genesisOutputScript = CScript() << ParseHex("0431018b45e1c058b22087a8e9ecbbf3732f8df913cf0440bf3b89e8dba2d61b5feb6df9c57d16c8b2e33416b819a5f8d13bd2d4d7a6570cec7df116f943e509ae") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000a590ed706934147c82efcb223b9519a44fa86ad4263a11f555f6b1510e2"); 
        ...
        genesis = CreateGenesisBlock(1624958004, 244960, 0x1e0ffff0, 1, 1000 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000a590ed706934147c82efcb223b9519a44fa86ad4263a11f555f6b1510e2"));
        assert(genesis.hashMerkleRoot == uint256S("0x4e9272d84607ebab3f3c203b6fd8b31aa264bf1d9f4e2fcf739206e6767c96ff"));
        ...
        vSporkAddresses = {"MBai5kXbNsABbNYo5DA9553fVodye4fWfg"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00000a590ed706934147c82efcb223b9519a44fa86ad4263a11f555f6b1510e2")},
            }
        };

        chainTxData = ChainTxData{
            1624958004, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000011a9d90354e280f5d26bf9c39007f5a0584658769203f151256fa00768f"); 
        ...
        genesis = CreateGenesisBlock(1624958009UL, 1567769UL, 0x1e0ffff0, 1, 1000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000011a9d90354e280f5d26bf9c39007f5a0584658769203f151256fa00768f"));
        assert(genesis.hashMerkleRoot == uint256S("0x4e9272d84607ebab3f3c203b6fd8b31aa264bf1d9f4e2fcf739206e6767c96ff"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,178);
        // Testnet SafeMine BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet SafeMine BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet SafeMine BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"MHDYFTdcU7LtEK9ksh82ezTEbrCnNK3ZiN"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x0000011a9d90354e280f5d26bf9c39007f5a0584658769203f151256fa00768f")},
            }
        };

        chainTxData = ChainTxData{
            1624958009, // * UNIX timestamp of last known number of transactions
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1624958014, 3, 0x207fffff, 1, 1000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x13a8d1a6b79aabed1ff6482c57438d2d3a194efdb374b34e62972faf2454ded2"));
        assert(genesis.hashMerkleRoot == uint256S("0x4e9272d84607ebab3f3c203b6fd8b31aa264bf1d9f4e2fcf739206e6767c96ff"));

        if (!fHelpOnly) {
            devnetGenesis = FindDevNetGenesisBlock(genesis, 1000 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x13a8d1a6b79aabed1ff6482c57438d2d3a194efdb374b34e62972faf2454ded2")},
...
public:
    CRegTestParams() {
        ...
        // privKey: 6zboKHFnk3skxAfkacsNUN3NJAPHoea1xjMB4dHyjG54ERNfV85
        vSporkAddresses = {"MHSZJqDusRGzW7wFQbYtXWRBYqJiDrYhqd"};
        nMinSporkKeys = 1;
        ...
        // Regtest SafeMine addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);
        // Regtest SafeMine script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,51);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,178);
        // Regtest SafeMine BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest SafeMine BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest SafeMine BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
