...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            " - \"safemine\" activates all SafeMine-specific categories at once;\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "safemine")
            + HelpExampleRpc("debug", "safemine+net")
        );
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given safemine address.\n"
            ...
            "\nArguments:\n"
            "1. \"address\"                    (string, required) The safemine address to validate\n"
            "\nResult:\n"
            "{\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The safemine address to use for the signature.\n"
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The difference of Satimintos\n"
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "    \"satoshis\"  (number) The number of Satimintos of the output\n"
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\": xxxxx,              (numeric) The current total balance in Satimintos\n"
            "  \"balance_immature\": xxxxx,     (numeric) The current immature balance in Satimintos\n"
            "  \"balance_spendable\": xxxxx,    (numeric) The current spendable balance in Satimintos\n"
            "  \"received\": xxxxx              (numeric) The total number of Satimintos received (including change)\n"
            "}\n"
            "\nExamples:\n"
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "safemine-cli and the GUI. There is no server-side difference."
        );
...
static UniValue getinfo_deprecated(const JSONRPCRequest& request)
{
    throw JSONRPCError(RPC_METHOD_NOT_FOUND,
        ...
        "\nsafemine-cli has the option -getinfo to collect and format these in the old format."
    );
}
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* SafeMine features */
    { "safemine",               "mnsync",                 &mnsync,                 {} },
    { "safemine",               "spork",                  &spork,                  {"arg0","value"} },
