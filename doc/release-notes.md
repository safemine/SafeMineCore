...
provided in [DIP-0020](https://github.com/safeminepay/dips/blob/master/dip-0020.md).
...
from other quorum members. This allows SafeMine Platform to obtain required
...
provided in [DIP-0021](https://github.com/safeminepay/dips/blob/master/dip-0021.md).

Platform support
----------------
Support for SafeMine Platform has been expanded through the addition of a new
...
BLS update
----------
SafeMine Core’s BLS signature library has been updated based on v1.0 of the
Chia BLS library to support migration to a new BLS signature scheme which will
be implemented in a future version of SafeMine. These changes will be made to
align with standards and improve security.

Network performance improvements
--------------------------------
This version of SafeMine Core includes multiple optimizations to the network and
p2p message handling code.

We reintroduced [Intra-Quorum Connections](https://github.com/safeminepay/dips/blob/master/dip-0006.md#intra-quorum-communication)
...
reliability. Activation of `SPORK_22_PS_MORE_PARTICIPANTS` in SafeMine v0.16
...
Statoshi backport
------------------
This version includes a [backport](https://github.com/safeminepay/safemine/pull/2515)
...
RPC changes
-----------
There are seven new RPC commands which are SafeMine specific and seven new RPC
...
will be removed in SafeMine v0.18. Note that the deprecation of wallet accounts
...
Please check `Help -> Command-line options` in Qt wallet or `safemined --help` for
more information.
...
SafeMine users. Bitcoin changes that do not align with SafeMine’s product needs, such
...
See detailed [set of changes](https://github.com/safeminepay/safemine/compare/v0.16.1.1...safeminepay:v0.17.0.2).
...
SafeMine was previously known as Darkcoin.
...
- [v0.16.1.1](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.16.1.1.md) released November/17/2020
- [v0.16.1.0](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.16.1.0.md) released November/14/2020
- [v0.16.0.1](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.16.0.1.md) released September/30/2020
- [v0.15.0.0](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.15.0.0.md) released Febrary/18/2020
- [v0.14.0.5](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.14.0.5.md) released December/08/2019
- [v0.14.0.4](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.14.0.4.md) released November/22/2019
- [v0.14.0.3](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.14.0.3.md) released August/15/2019
- [v0.14.0.2](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.14.0.2.md) released July/4/2019
- [v0.14.0.1](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.14.0.1.md) released May/31/2019
- [v0.14.0](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.14.0.md) released May/22/2019
- [v0.13.3](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.13.3.md) released Apr/04/2019
- [v0.13.2](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.13.2.md) released Mar/15/2019
- [v0.13.1](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.13.1.md) released Feb/9/2019
- [v0.13.0](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.13.0.md) released Jan/14/2019
- [v0.12.3.4](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.12.3.4.md) released Dec/14/2018
- [v0.12.3.3](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.12.3.3.md) released Sep/19/2018
- [v0.12.3.2](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.12.3.2.md) released Jul/09/2018
- [v0.12.3.1](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.12.3.1.md) released Jul/03/2018
- [v0.12.2.3](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.12.2.3.md) released Jan/12/2018
- [v0.12.2.2](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.12.2.2.md) released Dec/17/2017
- [v0.12.2](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.12.2.md) released Nov/08/2017
- [v0.12.1](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.12.1.md) released Feb/06/2017
- [v0.12.0](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.12.0.md) released Aug/15/2015
- [v0.11.2](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.11.2.md) released Mar/04/2015
- [v0.11.1](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.11.1.md) released Feb/10/2015
- [v0.11.0](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.11.0.md) released Jan/15/2015
- [v0.10.x](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.10.0.md) released Sep/25/2014
- [v0.9.x](https://github.com/safeminepay/safemine/blob/master/doc/release-notes/safemine/release-notes-0.9.0.md) released Mar/13/2014
