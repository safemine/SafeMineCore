...
This document provides guidelines for internationalization of the SafeMine Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `safemine_en.ts` remains unchanged.
