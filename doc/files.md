...
* safemine.conf: contains configuration settings for safemined or safemine-qt
* safemined.pid: stores the process id of safemined while running
...
* debug.log: contains debug information and general logging generated by safemined or safemine-qt
