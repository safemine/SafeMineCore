...
Arguments:
    <base_directory> - The base directory of a SafeMine Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The SafeMine Core developers'
...
Arguments:
    <base_directory> - The base directory of SafeMine Core source code repository.
"""
...
Arguments:
    <file> - A source file in the SafeMine Core repository.
"""
