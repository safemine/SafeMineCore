...
official/supported Docker Images found at https://hub.docker.com/r/safeminepay/safemined/
...
**NOTE: Please update the image description at https://hub.docker.com/r/safeminepay/safemined-develop/ when changing the above text**