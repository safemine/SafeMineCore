Contributing to SafeMine Core
============================

The SafeMine Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/safeminepay/safemine/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the SafeMine Core project (and related
projects such as libsecp256k1), and is not to be confused with overall SafeMine
Network Protocol consensus changes.

Whether a pull request is merged into SafeMine Core rests with the project merge
...
Patches that change SafeMine consensus rules are considerably more involved than
...
Where a patch set proposes to change the SafeMine consensus, it must have been
...
The review process is normally fairly responsive on the SafeMine Core repository, however
...
The project leader is the release manager for each SafeMine Core release.
