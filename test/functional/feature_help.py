...
"""Verify that starting safemined with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start safemined with -h for help text")
        ...
        self.log.info("Start safemined with -version for version information")
