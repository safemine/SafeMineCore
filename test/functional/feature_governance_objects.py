...
"""Tests around safemine governance objects."""
...
class SafeMineGovernanceTest (SafeMineTestFramework):
    def set_test_params(self):
        self.set_safemine_test_params(2, 1)
