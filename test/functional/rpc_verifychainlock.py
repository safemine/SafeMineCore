...
class RPCVerifyChainLockTest(SafeMineTestFramework):
    def set_test_params(self):
        # -whitelist is needed to avoid the trickling logic on node0
        self.set_safemine_test_params(5, 3, [["-whitelist=127.0.0.1"], [], [], [], []], fast_dip3_enforcement=True)
        self.set_safemine_llmq_test_params(3, 2)
