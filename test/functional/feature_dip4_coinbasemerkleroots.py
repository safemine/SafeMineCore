...
from test_framework.test_framework import SafeMineTestFramework
...
class LLMQCoinbaseCommitmentsTest(SafeMineTestFramework):
    def set_test_params(self):
        self.set_safemine_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as SafeMineTestFramework doesn't support this atm)
