...
"""Test the safemine specific ZMQ notification interfaces."""
...
from test_framework.test_framework import (
     SafeMineTestFramework, skip_if_no_bitcoind_zmq, skip_if_no_py3_zmq)
...
class SafeMineZMQTest (SafeMineTestFramework):
    def set_test_params(self):
        ...
        self.set_safemine_test_params(4, 3, fast_dip3_enforcement=True, extra_args=[node0_extra_args, [], [], []])

    def run_test(self):
        # Check that safemined has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all safemine related ZMQ publisher
